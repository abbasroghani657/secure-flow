...
export const PRICING = [
  ...
  { name: "Pro", price: "$29", period: "/ month", blurb: "For teams that ship.", cta: "Start Pro", featured: true,
    features: ["10 targets, 100 scans / month", "All 15 scanners + active testing", "Full fixes, evidence & remediation", "CI/CD: GitHub Action + API tokens", "Slack, Teams & webhook alerts", "Scheduling + KEV/EPSS + compliance"] },
